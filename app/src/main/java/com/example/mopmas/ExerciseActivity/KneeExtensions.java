...
public class KneeExtensions extends AppCompatActivity {
    private static final long START_TIME_IN_MILLIS = 300000;
    private Button bt,bt1,bt2;
    private TextView tx,tx1,tx2;
    private CardView cardView;
    private ImageView img;
    private String tag="Knee Extension";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_knee_extensions);
        ...
        bt1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bottomSheetDialog.setExerciseType(tag);
