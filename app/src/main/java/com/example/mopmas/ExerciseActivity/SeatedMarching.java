...
public class SeatedMarching extends AppCompatActivity {
    ...
    int Extime;
    String exerciseType="Legs";
    String exerciseName="Seated Marching";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seated_marching);
        ...
        bt1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bottomSheetDialog.setExercise(exerciseName);
                bottomSheetDialog.setExerciseType(exerciseType);
